...
<body>
    ...
    <div class="container my-5" style="max-width: 760px;">
        ...
        <!-- Cabeçalho da Página -->
        <h1 class="fw-bold text-white mb-2 fs-2">Atualizar local</h1>
        <p class="text-secondary mb-4">
            Atualize um local que esteja vinculado às observações.
        </p>
        ...
        <div class="form-observacao-card">
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control input-astro" id="nome_local" name="nome_local" value="<?php echo $info_Especifica['nomeLocal'] ?>" placeholder="Digite o nome do local..." required>
                </div>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control input-astro" id="cidade" name="cidade" value="<?php echo $info_Especifica['cidade'] ?>"  placeholder="Digite a cidade..." required>
                    </div>
                    <div class="col-md-6">
                        <label for="estado" class="form-label text-white fw-semibold small">Estado</label>
                        <input type="text" class="form-control input-astro" id="estado" name="estado" value="<?php echo $info_Especifica['estado'] ?>" placeholder="Digite o estado..." required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control input-astro" id="pais" name="pais" value="<?php echo $info_Especifica['pais'] ?>" placeholder="Digite o país..." required>
                </div>

                <!-- Descrição -->
                <div class="mb-4">
                    <label for="descricao" class="form-label text-white fw-semibold small">Descrição</label>
                    <textarea id="descricao" name="descricao" class="form-control input-astro" rows="4" required><?= $info_Especifica['descricao'] ?></textarea>
                </div>
                ...
                <div class="row g-3 pt-2">
                    ...
                    <div class="col-6">
                        <button type="submit" class="btn btn-submeter w-100">Atualizar Local
                            <?php 
                                if(isset($_POST['nome_local'])){
                                    ...
                                    if($nomeLocal && $cidade && $estado && $pais && $descricao){
                                        $mensagem = $atualizar->atualizarLocal($conexao, $idLocal, $nomeLocal, $cidade, $estado, $pais, $descricao);
                                    }
